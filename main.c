 ...
 *                                SETTINGS                                *
 *                                                                        *
 *    You can modify values of constants or the function definitions.     *
 *                                                                        *
 *************************************************************************/
 ...
 * 
 * @param time       the run time of the process
...
{
    process_type *p = &state->processes[state->curr_args.process_id];
...
{
    process_type *process = &state->processes[state->curr_args.process_id];
...
static bool parse_process_id(unsigned pid, state *state)
{
    ...
    state->curr_args.process_id = pid;
    return true;
}
